...
select *
from customer c
join sales_rep sr on c.sales_rep_num=sr.sales_rep_num
where c.sales_rep_num=20;
...
select *, (num_ordered * quoted_price) as 'Total Price'
from order_line
...
select count(customer_name) as 'Total Customers' from customer;
